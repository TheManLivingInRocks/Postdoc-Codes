...
%%%%%%% 网格参数和物性参数 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Defines_Mesh_and_Physical_Parameters_TAE_SGR();
...
%             annotation('textbox',[0.2,0.4,0.25,0.5],'LineStyle','none','LineWidth',2,'String',strings,'Fontname','Times New Roman','fontweight','bold');
            ...
            %   质点速度垂直分量的波场快照    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            figure('Name','TAE_qz_explosive','Units','centimeters','Position',[10,10,7.3,5.45]);
            surf(x_main_region,z_main_region,q_z_last_half(PML_l + 1:nz_PML - PML_l,PML_l + 1:nx_PML - PML_l));
            set(gca,'Fontname','Times New Roman','fontweight','bold','FontSize',10);
            str_title = ['\Delta q_Z, (t=',num2str(t*1e3),'ms)'];
            title(str_title,'Fontname','Times New Roman','fontweight','bold','FontSize',10);
            shading interp;
            view(0,270);
            xlabel('X(m)');
